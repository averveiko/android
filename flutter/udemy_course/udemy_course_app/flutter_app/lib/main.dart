...
import 'package:flutter_app/provider_hw.dart';
...
void main() {
  ...
  //runApp(MyProviderDemoApp()); // Работа с состоянием при помощи Provider
  runApp(MyProviderHWApp()); // Домашняя работа по лекции Provider
}
